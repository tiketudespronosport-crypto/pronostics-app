    ...
    matches: [
      {
        ...
        result: "won", proof: { cote: 1.65, mise: null, gains: null, score: "0 - 1" },
        args: [
      ...
      },
      {
        ...
        result: "won", proof: { cote: 1.71, mise: null, gains: null, score: "1 - 3" },
        args: [
      ...
      },
      {
        ...
        result: "lost", proof: { cote: 1.64, mise: null, gains: null, score: "0 - 0" },
        args: [
      ...
      },
      {
        ...
        result: "void", proof: { cote: 1.45, mise: null, gains: null, score: "1 - 1" },
        args: [
      ...
      },
      {
        ...
        result: "won", proof: { cote: 1.94, mise: null, gains: null, score: "0 - 2" },
        args: [
      ...
      },
      {
        ...
        day: "Sam", date: "22 août", time: "18:45",
        result: "lost", proof: { cote: 1.70, mise: null, gains: null, score: "0 - 0" },
        args: [
